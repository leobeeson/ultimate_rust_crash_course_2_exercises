...
//! ![pumpkin_pic](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
/// 
/// # Recipes
/// Recipes are coming soon, so stay tuned!
pub struct Pumpkin {
    /// It is a percentage.
    pub roundness: f32,
...
impl Pumpkin {
    /// Smashes the pumpkin. If you smash the pumpkin, it will be gone. Then it can't be used for pie. :'-(
    pub fn smash(self) {}
}
...
/// Represents a special level of "orangeness" for the `orangeness` field of `Pumpkin`.
...
// Answer: `cargo doc --no-deps --open --document-private-items`
