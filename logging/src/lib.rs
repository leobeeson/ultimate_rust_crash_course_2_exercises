...
impl Frog {
    ...
    pub fn hop(&mut self) {
        ...
        if self.energy == 0 {
            warn!(target: "Frog::hop", "Frog will go to sleep. Energy has dropped to zero.");
...
impl Default for Frog {
    fn default() -> Self {
        ...
        trace!(target: "Frog::default", "A default Frog was generated with its default representation.");
        Frog {
            energy: 5,
            sleeping: false,
        }
